...
final class VanillaItems{
	...
	private static function init() : void{
		...
		foreach($source->getAllValues() as $name => $value){
			...
			match($name){
				"acacia_boat" => self::unsafeAssign(fn(Boat $v) => self::$_mACACIA_BOAT = $v, $value),
				"acacia_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mACACIA_HANGING_SIGN = $v, $value),
				"acacia_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mACACIA_SIGN = $v, $value),
				"air" => self::unsafeAssign(fn(Item $v) => self::$_mAIR = $v, $value),
				"amethyst_shard" => self::unsafeAssign(fn(Item $v) => self::$_mAMETHYST_SHARD = $v, $value),
				"apple" => self::unsafeAssign(fn(Apple $v) => self::$_mAPPLE = $v, $value),
				"arrow" => self::unsafeAssign(fn(Arrow $v) => self::$_mARROW = $v, $value),
				"baked_potato" => self::unsafeAssign(fn(BakedPotato $v) => self::$_mBAKED_POTATO = $v, $value),
				"bamboo" => self::unsafeAssign(fn(Bamboo $v) => self::$_mBAMBOO = $v, $value),
				"banner" => self::unsafeAssign(fn(Banner $v) => self::$_mBANNER = $v, $value),
				"beetroot" => self::unsafeAssign(fn(Beetroot $v) => self::$_mBEETROOT = $v, $value),
				"beetroot_seeds" => self::unsafeAssign(fn(BeetrootSeeds $v) => self::$_mBEETROOT_SEEDS = $v, $value),
				"beetroot_soup" => self::unsafeAssign(fn(BeetrootSoup $v) => self::$_mBEETROOT_SOUP = $v, $value),
				"birch_boat" => self::unsafeAssign(fn(Boat $v) => self::$_mBIRCH_BOAT = $v, $value),
				"birch_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mBIRCH_HANGING_SIGN = $v, $value),
				"birch_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mBIRCH_SIGN = $v, $value),
				"blaze_powder" => self::unsafeAssign(fn(Item $v) => self::$_mBLAZE_POWDER = $v, $value),
				"blaze_rod" => self::unsafeAssign(fn(BlazeRod $v) => self::$_mBLAZE_ROD = $v, $value),
				"bleach" => self::unsafeAssign(fn(Item $v) => self::$_mBLEACH = $v, $value),
				"bone" => self::unsafeAssign(fn(Item $v) => self::$_mBONE = $v, $value),
				"bone_meal" => self::unsafeAssign(fn(Fertilizer $v) => self::$_mBONE_MEAL = $v, $value),
				"book" => self::unsafeAssign(fn(Book $v) => self::$_mBOOK = $v, $value),
				"bow" => self::unsafeAssign(fn(Bow $v) => self::$_mBOW = $v, $value),
				"bowl" => self::unsafeAssign(fn(Bowl $v) => self::$_mBOWL = $v, $value),
				"bread" => self::unsafeAssign(fn(Bread $v) => self::$_mBREAD = $v, $value),
				"brick" => self::unsafeAssign(fn(Item $v) => self::$_mBRICK = $v, $value),
				"bucket" => self::unsafeAssign(fn(Bucket $v) => self::$_mBUCKET = $v, $value),
				"carrot" => self::unsafeAssign(fn(Carrot $v) => self::$_mCARROT = $v, $value),
				"chainmail_boots" => self::unsafeAssign(fn(Armor $v) => self::$_mCHAINMAIL_BOOTS = $v, $value),
				"chainmail_chestplate" => self::unsafeAssign(fn(Armor $v) => self::$_mCHAINMAIL_CHESTPLATE = $v, $value),
				"chainmail_helmet" => self::unsafeAssign(fn(Armor $v) => self::$_mCHAINMAIL_HELMET = $v, $value),
				"chainmail_leggings" => self::unsafeAssign(fn(Armor $v) => self::$_mCHAINMAIL_LEGGINGS = $v, $value),
				"charcoal" => self::unsafeAssign(fn(Coal $v) => self::$_mCHARCOAL = $v, $value),
				"chemical_aluminium_oxide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_ALUMINIUM_OXIDE = $v, $value),
				"chemical_ammonia" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_AMMONIA = $v, $value),
				"chemical_barium_sulphate" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_BARIUM_SULPHATE = $v, $value),
				"chemical_benzene" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_BENZENE = $v, $value),
				"chemical_boron_trioxide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_BORON_TRIOXIDE = $v, $value),
				"chemical_calcium_bromide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_CALCIUM_BROMIDE = $v, $value),
				"chemical_calcium_chloride" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_CALCIUM_CHLORIDE = $v, $value),
				"chemical_cerium_chloride" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_CERIUM_CHLORIDE = $v, $value),
				"chemical_charcoal" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_CHARCOAL = $v, $value),
				"chemical_crude_oil" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_CRUDE_OIL = $v, $value),
				"chemical_glue" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_GLUE = $v, $value),
				"chemical_hydrogen_peroxide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_HYDROGEN_PEROXIDE = $v, $value),
				"chemical_hypochlorite" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_HYPOCHLORITE = $v, $value),
				"chemical_ink" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_INK = $v, $value),
				"chemical_iron_sulphide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_IRON_SULPHIDE = $v, $value),
				"chemical_latex" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_LATEX = $v, $value),
				"chemical_lithium_hydride" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_LITHIUM_HYDRIDE = $v, $value),
				"chemical_luminol" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_LUMINOL = $v, $value),
				"chemical_magnesium_nitrate" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_MAGNESIUM_NITRATE = $v, $value),
				"chemical_magnesium_oxide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_MAGNESIUM_OXIDE = $v, $value),
				"chemical_magnesium_salts" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_MAGNESIUM_SALTS = $v, $value),
				"chemical_mercuric_chloride" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_MERCURIC_CHLORIDE = $v, $value),
				"chemical_polyethylene" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_POLYETHYLENE = $v, $value),
				"chemical_potassium_chloride" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_POTASSIUM_CHLORIDE = $v, $value),
				"chemical_potassium_iodide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_POTASSIUM_IODIDE = $v, $value),
				"chemical_rubbish" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_RUBBISH = $v, $value),
				"chemical_salt" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SALT = $v, $value),
				"chemical_soap" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SOAP = $v, $value),
				"chemical_sodium_acetate" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SODIUM_ACETATE = $v, $value),
				"chemical_sodium_fluoride" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SODIUM_FLUORIDE = $v, $value),
				"chemical_sodium_hydride" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SODIUM_HYDRIDE = $v, $value),
				"chemical_sodium_hydroxide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SODIUM_HYDROXIDE = $v, $value),
				"chemical_sodium_hypochlorite" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SODIUM_HYPOCHLORITE = $v, $value),
				"chemical_sodium_oxide" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SODIUM_OXIDE = $v, $value),
				"chemical_sugar" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SUGAR = $v, $value),
				"chemical_sulphate" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_SULPHATE = $v, $value),
				"chemical_tungsten_chloride" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_TUNGSTEN_CHLORIDE = $v, $value),
				"chemical_water" => self::unsafeAssign(fn(Item $v) => self::$_mCHEMICAL_WATER = $v, $value),
				"cherry_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mCHERRY_HANGING_SIGN = $v, $value),
				"cherry_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mCHERRY_SIGN = $v, $value),
				"chorus_fruit" => self::unsafeAssign(fn(ChorusFruit $v) => self::$_mCHORUS_FRUIT = $v, $value),
				"clay" => self::unsafeAssign(fn(Item $v) => self::$_mCLAY = $v, $value),
				"clock" => self::unsafeAssign(fn(Clock $v) => self::$_mCLOCK = $v, $value),
				"clownfish" => self::unsafeAssign(fn(Clownfish $v) => self::$_mCLOWNFISH = $v, $value),
				"coal" => self::unsafeAssign(fn(Coal $v) => self::$_mCOAL = $v, $value),
				"coast_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mCOAST_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"cocoa_beans" => self::unsafeAssign(fn(CocoaBeans $v) => self::$_mCOCOA_BEANS = $v, $value),
				"compass" => self::unsafeAssign(fn(Compass $v) => self::$_mCOMPASS = $v, $value),
				"cooked_chicken" => self::unsafeAssign(fn(CookedChicken $v) => self::$_mCOOKED_CHICKEN = $v, $value),
				"cooked_fish" => self::unsafeAssign(fn(CookedFish $v) => self::$_mCOOKED_FISH = $v, $value),
				"cooked_mutton" => self::unsafeAssign(fn(CookedMutton $v) => self::$_mCOOKED_MUTTON = $v, $value),
				"cooked_porkchop" => self::unsafeAssign(fn(CookedPorkchop $v) => self::$_mCOOKED_PORKCHOP = $v, $value),
				"cooked_rabbit" => self::unsafeAssign(fn(CookedRabbit $v) => self::$_mCOOKED_RABBIT = $v, $value),
				"cooked_salmon" => self::unsafeAssign(fn(CookedSalmon $v) => self::$_mCOOKED_SALMON = $v, $value),
				"cookie" => self::unsafeAssign(fn(Cookie $v) => self::$_mCOOKIE = $v, $value),
				"copper_axe" => self::unsafeAssign(fn(Axe $v) => self::$_mCOPPER_AXE = $v, $value),
				"copper_boots" => self::unsafeAssign(fn(Armor $v) => self::$_mCOPPER_BOOTS = $v, $value),
				"copper_chestplate" => self::unsafeAssign(fn(Armor $v) => self::$_mCOPPER_CHESTPLATE = $v, $value),
				"copper_helmet" => self::unsafeAssign(fn(Armor $v) => self::$_mCOPPER_HELMET = $v, $value),
				"copper_hoe" => self::unsafeAssign(fn(Hoe $v) => self::$_mCOPPER_HOE = $v, $value),
				"copper_ingot" => self::unsafeAssign(fn(Item $v) => self::$_mCOPPER_INGOT = $v, $value),
				"copper_leggings" => self::unsafeAssign(fn(Armor $v) => self::$_mCOPPER_LEGGINGS = $v, $value),
				"copper_nugget" => self::unsafeAssign(fn(Item $v) => self::$_mCOPPER_NUGGET = $v, $value),
				"copper_pickaxe" => self::unsafeAssign(fn(Pickaxe $v) => self::$_mCOPPER_PICKAXE = $v, $value),
				"copper_shovel" => self::unsafeAssign(fn(Shovel $v) => self::$_mCOPPER_SHOVEL = $v, $value),
				"copper_sword" => self::unsafeAssign(fn(Sword $v) => self::$_mCOPPER_SWORD = $v, $value),
				"coral_fan" => self::unsafeAssign(fn(CoralFan $v) => self::$_mCORAL_FAN = $v, $value),
				"crimson_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mCRIMSON_HANGING_SIGN = $v, $value),
				"crimson_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mCRIMSON_SIGN = $v, $value),
				"dark_oak_boat" => self::unsafeAssign(fn(Boat $v) => self::$_mDARK_OAK_BOAT = $v, $value),
				"dark_oak_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mDARK_OAK_HANGING_SIGN = $v, $value),
				"dark_oak_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mDARK_OAK_SIGN = $v, $value),
				"diamond" => self::unsafeAssign(fn(Item $v) => self::$_mDIAMOND = $v, $value),
				"diamond_axe" => self::unsafeAssign(fn(Axe $v) => self::$_mDIAMOND_AXE = $v, $value),
				"diamond_boots" => self::unsafeAssign(fn(Armor $v) => self::$_mDIAMOND_BOOTS = $v, $value),
				"diamond_chestplate" => self::unsafeAssign(fn(Armor $v) => self::$_mDIAMOND_CHESTPLATE = $v, $value),
				"diamond_helmet" => self::unsafeAssign(fn(Armor $v) => self::$_mDIAMOND_HELMET = $v, $value),
				"diamond_hoe" => self::unsafeAssign(fn(Hoe $v) => self::$_mDIAMOND_HOE = $v, $value),
				"diamond_leggings" => self::unsafeAssign(fn(Armor $v) => self::$_mDIAMOND_LEGGINGS = $v, $value),
				"diamond_pickaxe" => self::unsafeAssign(fn(Pickaxe $v) => self::$_mDIAMOND_PICKAXE = $v, $value),
				"diamond_shovel" => self::unsafeAssign(fn(Shovel $v) => self::$_mDIAMOND_SHOVEL = $v, $value),
				"diamond_sword" => self::unsafeAssign(fn(Sword $v) => self::$_mDIAMOND_SWORD = $v, $value),
				"disc_fragment_5" => self::unsafeAssign(fn(Item $v) => self::$_mDISC_FRAGMENT_5 = $v, $value),
				"dragon_breath" => self::unsafeAssign(fn(Item $v) => self::$_mDRAGON_BREATH = $v, $value),
				"dried_kelp" => self::unsafeAssign(fn(DriedKelp $v) => self::$_mDRIED_KELP = $v, $value),
				"dune_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mDUNE_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"dye" => self::unsafeAssign(fn(Dye $v) => self::$_mDYE = $v, $value),
				"echo_shard" => self::unsafeAssign(fn(Item $v) => self::$_mECHO_SHARD = $v, $value),
				"egg" => self::unsafeAssign(fn(Egg $v) => self::$_mEGG = $v, $value),
				"emerald" => self::unsafeAssign(fn(Item $v) => self::$_mEMERALD = $v, $value),
				"enchanted_book" => self::unsafeAssign(fn(EnchantedBook $v) => self::$_mENCHANTED_BOOK = $v, $value),
				"enchanted_golden_apple" => self::unsafeAssign(fn(GoldenAppleEnchanted $v) => self::$_mENCHANTED_GOLDEN_APPLE = $v, $value),
				"ender_pearl" => self::unsafeAssign(fn(EnderPearl $v) => self::$_mENDER_PEARL = $v, $value),
				"end_crystal" => self::unsafeAssign(fn(EndCrystal $v) => self::$_mEND_CRYSTAL = $v, $value),
				"experience_bottle" => self::unsafeAssign(fn(ExperienceBottle $v) => self::$_mEXPERIENCE_BOTTLE = $v, $value),
				"eye_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mEYE_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"feather" => self::unsafeAssign(fn(Item $v) => self::$_mFEATHER = $v, $value),
				"fermented_spider_eye" => self::unsafeAssign(fn(Item $v) => self::$_mFERMENTED_SPIDER_EYE = $v, $value),
				"firework_rocket" => self::unsafeAssign(fn(FireworkRocket $v) => self::$_mFIREWORK_ROCKET = $v, $value),
				"firework_star" => self::unsafeAssign(fn(FireworkStar $v) => self::$_mFIREWORK_STAR = $v, $value),
				"fire_charge" => self::unsafeAssign(fn(FireCharge $v) => self::$_mFIRE_CHARGE = $v, $value),
				"fishing_rod" => self::unsafeAssign(fn(FishingRod $v) => self::$_mFISHING_ROD = $v, $value),
				"flint" => self::unsafeAssign(fn(Item $v) => self::$_mFLINT = $v, $value),
				"flint_and_steel" => self::unsafeAssign(fn(FlintSteel $v) => self::$_mFLINT_AND_STEEL = $v, $value),
				"ghast_tear" => self::unsafeAssign(fn(Item $v) => self::$_mGHAST_TEAR = $v, $value),
				"glass_bottle" => self::unsafeAssign(fn(GlassBottle $v) => self::$_mGLASS_BOTTLE = $v, $value),
				"glistering_melon" => self::unsafeAssign(fn(Item $v) => self::$_mGLISTERING_MELON = $v, $value),
				"glowstone_dust" => self::unsafeAssign(fn(Item $v) => self::$_mGLOWSTONE_DUST = $v, $value),
				"glow_berries" => self::unsafeAssign(fn(GlowBerries $v) => self::$_mGLOW_BERRIES = $v, $value),
				"glow_ink_sac" => self::unsafeAssign(fn(Item $v) => self::$_mGLOW_INK_SAC = $v, $value),
				"goat_horn" => self::unsafeAssign(fn(GoatHorn $v) => self::$_mGOAT_HORN = $v, $value),
				"golden_apple" => self::unsafeAssign(fn(GoldenApple $v) => self::$_mGOLDEN_APPLE = $v, $value),
				"golden_axe" => self::unsafeAssign(fn(Axe $v) => self::$_mGOLDEN_AXE = $v, $value),
				"golden_boots" => self::unsafeAssign(fn(Armor $v) => self::$_mGOLDEN_BOOTS = $v, $value),
				"golden_carrot" => self::unsafeAssign(fn(GoldenCarrot $v) => self::$_mGOLDEN_CARROT = $v, $value),
				"golden_chestplate" => self::unsafeAssign(fn(Armor $v) => self::$_mGOLDEN_CHESTPLATE = $v, $value),
				"golden_helmet" => self::unsafeAssign(fn(Armor $v) => self::$_mGOLDEN_HELMET = $v, $value),
				"golden_hoe" => self::unsafeAssign(fn(Hoe $v) => self::$_mGOLDEN_HOE = $v, $value),
				"golden_leggings" => self::unsafeAssign(fn(Armor $v) => self::$_mGOLDEN_LEGGINGS = $v, $value),
				"golden_pickaxe" => self::unsafeAssign(fn(Pickaxe $v) => self::$_mGOLDEN_PICKAXE = $v, $value),
				"golden_shovel" => self::unsafeAssign(fn(Shovel $v) => self::$_mGOLDEN_SHOVEL = $v, $value),
				"golden_sword" => self::unsafeAssign(fn(Sword $v) => self::$_mGOLDEN_SWORD = $v, $value),
				"gold_ingot" => self::unsafeAssign(fn(Item $v) => self::$_mGOLD_INGOT = $v, $value),
				"gold_nugget" => self::unsafeAssign(fn(Item $v) => self::$_mGOLD_NUGGET = $v, $value),
				"gunpowder" => self::unsafeAssign(fn(Item $v) => self::$_mGUNPOWDER = $v, $value),
				"heart_of_the_sea" => self::unsafeAssign(fn(Item $v) => self::$_mHEART_OF_THE_SEA = $v, $value),
				"honeycomb" => self::unsafeAssign(fn(Item $v) => self::$_mHONEYCOMB = $v, $value),
				"honey_bottle" => self::unsafeAssign(fn(HoneyBottle $v) => self::$_mHONEY_BOTTLE = $v, $value),
				"host_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mHOST_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"ice_bomb" => self::unsafeAssign(fn(IceBomb $v) => self::$_mICE_BOMB = $v, $value),
				"ink_sac" => self::unsafeAssign(fn(Item $v) => self::$_mINK_SAC = $v, $value),
				"iron_axe" => self::unsafeAssign(fn(Axe $v) => self::$_mIRON_AXE = $v, $value),
				"iron_boots" => self::unsafeAssign(fn(Armor $v) => self::$_mIRON_BOOTS = $v, $value),
				"iron_chestplate" => self::unsafeAssign(fn(Armor $v) => self::$_mIRON_CHESTPLATE = $v, $value),
				"iron_helmet" => self::unsafeAssign(fn(Armor $v) => self::$_mIRON_HELMET = $v, $value),
				"iron_hoe" => self::unsafeAssign(fn(Hoe $v) => self::$_mIRON_HOE = $v, $value),
				"iron_ingot" => self::unsafeAssign(fn(Item $v) => self::$_mIRON_INGOT = $v, $value),
				"iron_leggings" => self::unsafeAssign(fn(Armor $v) => self::$_mIRON_LEGGINGS = $v, $value),
				"iron_nugget" => self::unsafeAssign(fn(Item $v) => self::$_mIRON_NUGGET = $v, $value),
				"iron_pickaxe" => self::unsafeAssign(fn(Pickaxe $v) => self::$_mIRON_PICKAXE = $v, $value),
				"iron_shovel" => self::unsafeAssign(fn(Shovel $v) => self::$_mIRON_SHOVEL = $v, $value),
				"iron_sword" => self::unsafeAssign(fn(Sword $v) => self::$_mIRON_SWORD = $v, $value),
				"jungle_boat" => self::unsafeAssign(fn(Boat $v) => self::$_mJUNGLE_BOAT = $v, $value),
				"jungle_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mJUNGLE_HANGING_SIGN = $v, $value),
				"jungle_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mJUNGLE_SIGN = $v, $value),
				"lapis_lazuli" => self::unsafeAssign(fn(Item $v) => self::$_mLAPIS_LAZULI = $v, $value),
				"lava_bucket" => self::unsafeAssign(fn(LiquidBucket $v) => self::$_mLAVA_BUCKET = $v, $value),
				"leather" => self::unsafeAssign(fn(Item $v) => self::$_mLEATHER = $v, $value),
				"leather_boots" => self::unsafeAssign(fn(Armor $v) => self::$_mLEATHER_BOOTS = $v, $value),
				"leather_cap" => self::unsafeAssign(fn(Armor $v) => self::$_mLEATHER_CAP = $v, $value),
				"leather_pants" => self::unsafeAssign(fn(Armor $v) => self::$_mLEATHER_PANTS = $v, $value),
				"leather_tunic" => self::unsafeAssign(fn(Armor $v) => self::$_mLEATHER_TUNIC = $v, $value),
				"lingering_potion" => self::unsafeAssign(fn(SplashPotion $v) => self::$_mLINGERING_POTION = $v, $value),
				"magma_cream" => self::unsafeAssign(fn(Item $v) => self::$_mMAGMA_CREAM = $v, $value),
				"mangrove_boat" => self::unsafeAssign(fn(Boat $v) => self::$_mMANGROVE_BOAT = $v, $value),
				"mangrove_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mMANGROVE_HANGING_SIGN = $v, $value),
				"mangrove_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mMANGROVE_SIGN = $v, $value),
				"medicine" => self::unsafeAssign(fn(Medicine $v) => self::$_mMEDICINE = $v, $value),
				"melon" => self::unsafeAssign(fn(Melon $v) => self::$_mMELON = $v, $value),
				"melon_seeds" => self::unsafeAssign(fn(MelonSeeds $v) => self::$_mMELON_SEEDS = $v, $value),
				"milk_bucket" => self::unsafeAssign(fn(MilkBucket $v) => self::$_mMILK_BUCKET = $v, $value),
				"minecart" => self::unsafeAssign(fn(Minecart $v) => self::$_mMINECART = $v, $value),
				"mushroom_stew" => self::unsafeAssign(fn(MushroomStew $v) => self::$_mMUSHROOM_STEW = $v, $value),
				"name_tag" => self::unsafeAssign(fn(NameTag $v) => self::$_mNAME_TAG = $v, $value),
				"nautilus_shell" => self::unsafeAssign(fn(Item $v) => self::$_mNAUTILUS_SHELL = $v, $value),
				"netherite_axe" => self::unsafeAssign(fn(Axe $v) => self::$_mNETHERITE_AXE = $v, $value),
				"netherite_boots" => self::unsafeAssign(fn(Armor $v) => self::$_mNETHERITE_BOOTS = $v, $value),
				"netherite_chestplate" => self::unsafeAssign(fn(Armor $v) => self::$_mNETHERITE_CHESTPLATE = $v, $value),
				"netherite_helmet" => self::unsafeAssign(fn(Armor $v) => self::$_mNETHERITE_HELMET = $v, $value),
				"netherite_hoe" => self::unsafeAssign(fn(Hoe $v) => self::$_mNETHERITE_HOE = $v, $value),
				"netherite_ingot" => self::unsafeAssign(fn(Item $v) => self::$_mNETHERITE_INGOT = $v, $value),
				"netherite_leggings" => self::unsafeAssign(fn(Armor $v) => self::$_mNETHERITE_LEGGINGS = $v, $value),
				"netherite_pickaxe" => self::unsafeAssign(fn(Pickaxe $v) => self::$_mNETHERITE_PICKAXE = $v, $value),
				"netherite_scrap" => self::unsafeAssign(fn(Item $v) => self::$_mNETHERITE_SCRAP = $v, $value),
				"netherite_shovel" => self::unsafeAssign(fn(Shovel $v) => self::$_mNETHERITE_SHOVEL = $v, $value),
				"netherite_sword" => self::unsafeAssign(fn(Sword $v) => self::$_mNETHERITE_SWORD = $v, $value),
				"netherite_upgrade_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mNETHERITE_UPGRADE_SMITHING_TEMPLATE = $v, $value),
				"nether_brick" => self::unsafeAssign(fn(Item $v) => self::$_mNETHER_BRICK = $v, $value),
				"nether_quartz" => self::unsafeAssign(fn(Item $v) => self::$_mNETHER_QUARTZ = $v, $value),
				"nether_star" => self::unsafeAssign(fn(Item $v) => self::$_mNETHER_STAR = $v, $value),
				"oak_boat" => self::unsafeAssign(fn(Boat $v) => self::$_mOAK_BOAT = $v, $value),
				"oak_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mOAK_HANGING_SIGN = $v, $value),
				"oak_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mOAK_SIGN = $v, $value),
				"ominous_banner" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mOMINOUS_BANNER = $v, $value),
				"painting" => self::unsafeAssign(fn(PaintingItem $v) => self::$_mPAINTING = $v, $value),
				"pale_oak_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mPALE_OAK_HANGING_SIGN = $v, $value),
				"pale_oak_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mPALE_OAK_SIGN = $v, $value),
				"paper" => self::unsafeAssign(fn(Item $v) => self::$_mPAPER = $v, $value),
				"phantom_membrane" => self::unsafeAssign(fn(Item $v) => self::$_mPHANTOM_MEMBRANE = $v, $value),
				"pitcher_pod" => self::unsafeAssign(fn(PitcherPod $v) => self::$_mPITCHER_POD = $v, $value),
				"poisonous_potato" => self::unsafeAssign(fn(PoisonousPotato $v) => self::$_mPOISONOUS_POTATO = $v, $value),
				"popped_chorus_fruit" => self::unsafeAssign(fn(Item $v) => self::$_mPOPPED_CHORUS_FRUIT = $v, $value),
				"potato" => self::unsafeAssign(fn(Potato $v) => self::$_mPOTATO = $v, $value),
				"potion" => self::unsafeAssign(fn(Potion $v) => self::$_mPOTION = $v, $value),
				"prismarine_crystals" => self::unsafeAssign(fn(Item $v) => self::$_mPRISMARINE_CRYSTALS = $v, $value),
				"prismarine_shard" => self::unsafeAssign(fn(Item $v) => self::$_mPRISMARINE_SHARD = $v, $value),
				"pufferfish" => self::unsafeAssign(fn(Pufferfish $v) => self::$_mPUFFERFISH = $v, $value),
				"pumpkin_pie" => self::unsafeAssign(fn(PumpkinPie $v) => self::$_mPUMPKIN_PIE = $v, $value),
				"pumpkin_seeds" => self::unsafeAssign(fn(PumpkinSeeds $v) => self::$_mPUMPKIN_SEEDS = $v, $value),
				"rabbit_foot" => self::unsafeAssign(fn(Item $v) => self::$_mRABBIT_FOOT = $v, $value),
				"rabbit_hide" => self::unsafeAssign(fn(Item $v) => self::$_mRABBIT_HIDE = $v, $value),
				"rabbit_stew" => self::unsafeAssign(fn(RabbitStew $v) => self::$_mRABBIT_STEW = $v, $value),
				"raiser_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mRAISER_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"raw_beef" => self::unsafeAssign(fn(RawBeef $v) => self::$_mRAW_BEEF = $v, $value),
				"raw_chicken" => self::unsafeAssign(fn(RawChicken $v) => self::$_mRAW_CHICKEN = $v, $value),
				"raw_copper" => self::unsafeAssign(fn(Item $v) => self::$_mRAW_COPPER = $v, $value),
				"raw_fish" => self::unsafeAssign(fn(RawFish $v) => self::$_mRAW_FISH = $v, $value),
				"raw_gold" => self::unsafeAssign(fn(Item $v) => self::$_mRAW_GOLD = $v, $value),
				"raw_iron" => self::unsafeAssign(fn(Item $v) => self::$_mRAW_IRON = $v, $value),
				"raw_mutton" => self::unsafeAssign(fn(RawMutton $v) => self::$_mRAW_MUTTON = $v, $value),
				"raw_porkchop" => self::unsafeAssign(fn(RawPorkchop $v) => self::$_mRAW_PORKCHOP = $v, $value),
				"raw_rabbit" => self::unsafeAssign(fn(RawRabbit $v) => self::$_mRAW_RABBIT = $v, $value),
				"raw_salmon" => self::unsafeAssign(fn(RawSalmon $v) => self::$_mRAW_SALMON = $v, $value),
				"record_11" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_11 = $v, $value),
				"record_13" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_13 = $v, $value),
				"record_5" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_5 = $v, $value),
				"record_blocks" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_BLOCKS = $v, $value),
				"record_cat" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_CAT = $v, $value),
				"record_chirp" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_CHIRP = $v, $value),
				"record_creator" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_CREATOR = $v, $value),
				"record_creator_music_box" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_CREATOR_MUSIC_BOX = $v, $value),
				"record_far" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_FAR = $v, $value),
				"record_mall" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_MALL = $v, $value),
				"record_mellohi" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_MELLOHI = $v, $value),
				"record_otherside" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_OTHERSIDE = $v, $value),
				"record_pigstep" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_PIGSTEP = $v, $value),
				"record_precipice" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_PRECIPICE = $v, $value),
				"record_relic" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_RELIC = $v, $value),
				"record_stal" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_STAL = $v, $value),
				"record_strad" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_STRAD = $v, $value),
				"record_wait" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_WAIT = $v, $value),
				"record_ward" => self::unsafeAssign(fn(Record $v) => self::$_mRECORD_WARD = $v, $value),
				"recovery_compass" => self::unsafeAssign(fn(Item $v) => self::$_mRECOVERY_COMPASS = $v, $value),
				"redstone_dust" => self::unsafeAssign(fn(Redstone $v) => self::$_mREDSTONE_DUST = $v, $value),
				"resin_brick" => self::unsafeAssign(fn(Item $v) => self::$_mRESIN_BRICK = $v, $value),
				"rib_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mRIB_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"rotten_flesh" => self::unsafeAssign(fn(RottenFlesh $v) => self::$_mROTTEN_FLESH = $v, $value),
				"scute" => self::unsafeAssign(fn(Item $v) => self::$_mSCUTE = $v, $value),
				"sentry_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mSENTRY_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"shaper_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mSHAPER_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"shears" => self::unsafeAssign(fn(Shears $v) => self::$_mSHEARS = $v, $value),
				"shulker_shell" => self::unsafeAssign(fn(Item $v) => self::$_mSHULKER_SHELL = $v, $value),
				"silence_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mSILENCE_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"slimeball" => self::unsafeAssign(fn(Item $v) => self::$_mSLIMEBALL = $v, $value),
				"snout_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mSNOUT_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"snowball" => self::unsafeAssign(fn(Snowball $v) => self::$_mSNOWBALL = $v, $value),
				"spider_eye" => self::unsafeAssign(fn(SpiderEye $v) => self::$_mSPIDER_EYE = $v, $value),
				"spire_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mSPIRE_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"splash_potion" => self::unsafeAssign(fn(SplashPotion $v) => self::$_mSPLASH_POTION = $v, $value),
				"spruce_boat" => self::unsafeAssign(fn(Boat $v) => self::$_mSPRUCE_BOAT = $v, $value),
				"spruce_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mSPRUCE_HANGING_SIGN = $v, $value),
				"spruce_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mSPRUCE_SIGN = $v, $value),
				"spyglass" => self::unsafeAssign(fn(Spyglass $v) => self::$_mSPYGLASS = $v, $value),
				"squid_spawn_egg" => self::unsafeAssign(fn(SpawnEgg $v) => self::$_mSQUID_SPAWN_EGG = $v, $value),
				"steak" => self::unsafeAssign(fn(Steak $v) => self::$_mSTEAK = $v, $value),
				"stick" => self::unsafeAssign(fn(Stick $v) => self::$_mSTICK = $v, $value),
				"stone_axe" => self::unsafeAssign(fn(Axe $v) => self::$_mSTONE_AXE = $v, $value),
				"stone_hoe" => self::unsafeAssign(fn(Hoe $v) => self::$_mSTONE_HOE = $v, $value),
				"stone_pickaxe" => self::unsafeAssign(fn(Pickaxe $v) => self::$_mSTONE_PICKAXE = $v, $value),
				"stone_shovel" => self::unsafeAssign(fn(Shovel $v) => self::$_mSTONE_SHOVEL = $v, $value),
				"stone_sword" => self::unsafeAssign(fn(Sword $v) => self::$_mSTONE_SWORD = $v, $value),
				"string" => self::unsafeAssign(fn(StringItem $v) => self::$_mSTRING = $v, $value),
				"sugar" => self::unsafeAssign(fn(Item $v) => self::$_mSUGAR = $v, $value),
				"suspicious_stew" => self::unsafeAssign(fn(SuspiciousStew $v) => self::$_mSUSPICIOUS_STEW = $v, $value),
				"sweet_berries" => self::unsafeAssign(fn(SweetBerries $v) => self::$_mSWEET_BERRIES = $v, $value),
				"tide_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mTIDE_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"torchflower_seeds" => self::unsafeAssign(fn(TorchflowerSeeds $v) => self::$_mTORCHFLOWER_SEEDS = $v, $value),
				"totem" => self::unsafeAssign(fn(Totem $v) => self::$_mTOTEM = $v, $value),
				"trident" => self::unsafeAssign(fn(Trident $v) => self::$_mTRIDENT = $v, $value),
				"turtle_helmet" => self::unsafeAssign(fn(TurtleHelmet $v) => self::$_mTURTLE_HELMET = $v, $value),
				"vex_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mVEX_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"villager_spawn_egg" => self::unsafeAssign(fn(SpawnEgg $v) => self::$_mVILLAGER_SPAWN_EGG = $v, $value),
				"ward_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mWARD_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"warped_hanging_sign" => self::unsafeAssign(fn(HangingSign $v) => self::$_mWARPED_HANGING_SIGN = $v, $value),
				"warped_sign" => self::unsafeAssign(fn(ItemBlockWallOrFloor $v) => self::$_mWARPED_SIGN = $v, $value),
				"water_bucket" => self::unsafeAssign(fn(LiquidBucket $v) => self::$_mWATER_BUCKET = $v, $value),
				"wayfinder_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mWAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"wheat" => self::unsafeAssign(fn(Item $v) => self::$_mWHEAT = $v, $value),
				"wheat_seeds" => self::unsafeAssign(fn(WheatSeeds $v) => self::$_mWHEAT_SEEDS = $v, $value),
				"wild_armor_trim_smithing_template" => self::unsafeAssign(fn(Item $v) => self::$_mWILD_ARMOR_TRIM_SMITHING_TEMPLATE = $v, $value),
				"wooden_axe" => self::unsafeAssign(fn(Axe $v) => self::$_mWOODEN_AXE = $v, $value),
				"wooden_hoe" => self::unsafeAssign(fn(Hoe $v) => self::$_mWOODEN_HOE = $v, $value),
				"wooden_pickaxe" => self::unsafeAssign(fn(Pickaxe $v) => self::$_mWOODEN_PICKAXE = $v, $value),
				"wooden_shovel" => self::unsafeAssign(fn(Shovel $v) => self::$_mWOODEN_SHOVEL = $v, $value),
				"wooden_sword" => self::unsafeAssign(fn(Sword $v) => self::$_mWOODEN_SWORD = $v, $value),
				"writable_book" => self::unsafeAssign(fn(WritableBook $v) => self::$_mWRITABLE_BOOK = $v, $value),
				"written_book" => self::unsafeAssign(fn(WrittenBook $v) => self::$_mWRITTEN_BOOK = $v, $value),
				"zombie_spawn_egg" => self::unsafeAssign(fn(SpawnEgg $v) => self::$_mZOMBIE_SPAWN_EGG = $v, $value),
