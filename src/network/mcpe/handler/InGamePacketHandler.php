...
class InGamePacketHandler extends PacketHandler{
	...
	public function handleEmote(EmotePacket $packet) : bool{
		...
		$this->player->getWorld()->broadcastPacketToViewers($this->player->getPosition(), EmotePacket::create($packet->getEntityRuntimeIdField(), $event->getEmoteId(), EmotePacket::FLAG_SERVER));
