...
class NetworkSession{
	...
	public function syncAbilities(Player $for) : void{
		$isOp = $for->hasPermission(PermissionManager::getInstance()->getPermission(DefaultPermissions::ROOT_OPERATOR));
		...
		$boolAbilities = [
			...
			AbilitiesLayer::ABILITY_TELEPORT => $for->hasPermission(PermissionManager::getInstance()->getPermission(DefaultPermissionNames::COMMAND_TELEPORT_SELF)),
