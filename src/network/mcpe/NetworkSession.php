...
class NetworkSession{
	...
	public function syncAbilities(Player $for) : void{
		...
		$layers = [
			new AbilitiesLayer(AbilitiesLayer::LAYER_BASE, $boolAbilities, $for->getFlightSpeedMultiplier(), $for->getFlightSpeedMultiplier() / self::DEFAULT_FLIGHT_SPEED_MULTIPLIER, 0.1),
		];
