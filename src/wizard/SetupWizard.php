...
class SetupWizard{
	...
	public function run() : bool{
        ...
        $this->lang = new Language($lang, LanguageManager::loadLang(RESOURCE_PATH . 'locale/', $lang), LanguageManager::loadLang(RESOURCE_PATH . 'locale/', LanguageManager::FALLBACK_LANGUAGE));
