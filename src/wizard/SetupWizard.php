...
class SetupWizard{
	...
	public function run() : bool{
		...
		do{
			$lang = mb_strtolower($this->getInput("Language", "eng"), "US-ASCII");
			if(!isset($langs[$lang])){
		...
		if(mb_strtolower($this->getInput($this->lang->translate(KnownTranslationFactory::skip_installer()), "n", "y/N"), "US-ASCII") === "y"){
			$this->printIpDetails();
			return true;
		}
...
LICENSE;
		$this->writeLine();
		if(mb_strtolower($this->getInput($this->lang->translate(KnownTranslationFactory::accept_license()), "n", "y/N"), "US-ASCII") !== "y"){
	...
	private function generateUserFiles() : void{
		...
		$op = mb_strtolower($this->getInput($this->lang->translate(KnownTranslationFactory::op_who()), ""), "US-ASCII");
		if($op === ""){
		...
		$config = new Config(Path::join($this->dataPath, "server.properties"), Config::PROPERTIES);
		if(mb_strtolower($this->getInput($this->lang->translate(KnownTranslationFactory::whitelist_enable()), "n", "y/N"), "US-ASCII") === "y"){
	...
	private function networkFunctions() : void{
		...
		if(mb_strtolower($this->getInput($this->lang->translate(KnownTranslationFactory::query_disable()), "n", "y/N"), "US-ASCII") === "y"){
