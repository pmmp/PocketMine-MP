...
final class StringToItemParser extends StringToTParser{
	...
	private static function registerItems(self $result) : void{
		...
		$result->register("awkward_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::AWKWARD()));
		...
		$result->register("fire_resistance_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::FIRE_RESISTANCE()));
		...
		$result->register("harming_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::HARMING()));
		...
		$result->register("healing_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::HEALING()));
		...
		$result->register("invisibility_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::INVISIBILITY()));
		...
		$result->register("leaping_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LEAPING()));
		...
		$result->register("lingering_potion", fn() => Items::LINGERING_POTION());
		$result->register("long_fire_resistance_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_FIRE_RESISTANCE()));
		...
		$result->register("long_invisibility_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_INVISIBILITY()));
		...
		$result->register("long_leaping_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_LEAPING()));
		...
		$result->register("long_mundane_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_MUNDANE()));
		...
		$result->register("long_night_vision_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_NIGHT_VISION()));
		...
		$result->register("long_poison_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_POISON()));
		...
		$result->register("long_regeneration_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_REGENERATION()));
		...
		$result->register("long_slow_falling_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_SLOW_FALLING()));
		...
		$result->register("long_slowness_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_SLOWNESS()));
		...
		$result->register("long_strength_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_STRENGTH()));
		...
		$result->register("long_swiftness_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_SWIFTNESS()));
		...
		$result->register("long_turtle_master_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_TURTLE_MASTER()));
		...
		$result->register("long_water_breathing_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_WATER_BREATHING()));
		...
		$result->register("long_weakness_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::LONG_WEAKNESS()));
		...
		$result->register("mundane_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::MUNDANE()));
		...
		$result->register("night_vision_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::NIGHT_VISION()));
		...
		$result->register("poison_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::POISON()));
		...
		$result->register("regeneration_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::REGENERATION()));
		...
		$result->register("slow_falling_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::SLOW_FALLING()));
		...
		$result->register("slowness_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::SLOWNESS()));
		...
		$result->register("strength_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRENGTH()));
		...
		$result->register("strong_harming_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRONG_HARMING()));
		...
		$result->register("strong_healing_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRONG_HEALING()));
		...
		$result->register("strong_leaping_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRONG_LEAPING()));
		...
		$result->register("strong_poison_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRONG_POISON()));
		...
		$result->register("strong_regeneration_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRONG_REGENERATION()));
		...
		$result->register("strong_strength_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRONG_STRENGTH()));
		...
		$result->register("strong_swiftness_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRONG_SWIFTNESS()));
		...
		$result->register("strong_turtle_master_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::STRONG_TURTLE_MASTER()));
		...
		$result->register("swiftness_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::SWIFTNESS()));
		...
		$result->register("thick_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::THICK()));
		...
		$result->register("water_breathing_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::WATER_BREATHING()));
		...
		$result->register("water_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::WATER()));
		...
		$result->register("weakness_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::WEAKNESS()));
		...
		$result->register("wither_lingering_potion", fn() => Items::LINGERING_POTION()->setType(PotionType::WITHER()));
