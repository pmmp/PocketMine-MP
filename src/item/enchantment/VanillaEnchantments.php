 ...
 * @method static FortuneEnchantment FORTUNE()
...
final class VanillaEnchantments{
	...
	protected static function setup() : void{
		...
		self::register("FORTUNE", new FortuneEnchantment(KnownTranslationFactory::enchantment_lootBonusDigger(), Rarity::RARE, ItemFlags::DIG, ItemFlags::NONE, 3));
