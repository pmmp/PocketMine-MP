 ...
 * @method static Armor TURTLE_HELMET()
...
final class VanillaItems{
	...
	private static function registerArmorItems() : void{
		...
		self::register("turtle_helmet", new Armor(new IID(Ids::TURTLE_HELMET), "Turtle Shell", new ArmorTypeInfo(2, 276, ArmorInventory::SLOT_HEAD)));
