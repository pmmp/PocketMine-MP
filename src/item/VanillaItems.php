 ...
 * @method static SmithingTemplate DUNE_ARMOR_TRIM_SMITHING_TEMPLATE()
 ...
 * @method static SmithingTemplate EYE_ARMOR_TRIM_SMITHING_TEMPLATE()
 ...
 * @method static SmithingTemplate HOST_ARMOR_TRIM_SMITHING_TEMPLATE()
 ...
 * @method static SmithingTemplate NETHERITE_UPGRADE_SMITHING_TEMPLATE()
 ...
 * @method static SmithingTemplate RAISER_ARMOR_TRIM_SMITHING_TEMPLATE()
 ...
 * @method static SmithingTemplate RIB_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static RottenFlesh ROTTEN_FLESH()
 * @method static Item SCUTE()
 * @method static SmithingTemplate SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static SmithingTemplate SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static Shears SHEARS()
 * @method static Item SHULKER_SHELL()
 * @method static SmithingTemplate SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static Item SLIMEBALL()
 * @method static SmithingTemplate SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static Snowball SNOWBALL()
 * @method static SpiderEye SPIDER_EYE()
 * @method static SmithingTemplate SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE()
 ...
 * @method static SmithingTemplate TIDE_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static TorchflowerSeeds TORCHFLOWER_SEEDS()
 * @method static Totem TOTEM()
 * @method static TurtleHelmet TURTLE_HELMET()
 * @method static SmithingTemplate VEX_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static SpawnEgg VILLAGER_SPAWN_EGG()
 * @method static SmithingTemplate WARD_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static ItemBlockWallOrFloor WARPED_SIGN()
 * @method static LiquidBucket WATER_BUCKET()
 * @method static SmithingTemplate WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE()
 * @method static Item WHEAT()
 * @method static WheatSeeds WHEAT_SEEDS()
 * @method static SmithingTemplate WILD_ARMOR_TRIM_SMITHING_TEMPLATE()
...
final class VanillaItems{
	...
	private static function registerSmithingTemplates() : void{
		self::register("netherite_upgrade_smithing_template", new SmithingTemplate(new IID(Ids::NETHERITE_UPGRADE_SMITHING_TEMPLATE), "Netherite Upgrade Smithing Template"));
		self::register("coast_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::COAST_ARMOR_TRIM_SMITHING_TEMPLATE), "Coast Armor Trim Smithing Template"));
		self::register("dune_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::DUNE_ARMOR_TRIM_SMITHING_TEMPLATE), "Dune Armor Trim Smithing Template"));
		self::register("eye_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::EYE_ARMOR_TRIM_SMITHING_TEMPLATE), "Eye Armor Trim Smithing Template"));
		self::register("host_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::HOST_ARMOR_TRIM_SMITHING_TEMPLATE), "Host Armor Trim Smithing Template"));
		self::register("raiser_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::RAISER_ARMOR_TRIM_SMITHING_TEMPLATE), "Raiser Armor Trim Smithing Template"));
		self::register("rib_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::RIB_ARMOR_TRIM_SMITHING_TEMPLATE), "Rib Armor Trim Smithing Template"));
		self::register("sentry_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE), "Sentry Armor Trim Smithing Template"));
		self::register("shaper_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE), "Shaper Armor Trim Smithing Template"));
		self::register("silence_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE), "Silence Armor Trim Smithing Template"));
		self::register("snout_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE), "Snout Armor Trim Smithing Template"));
		self::register("spire_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE), "Spire Armor Trim Smithing Template"));
		self::register("tide_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::TIDE_ARMOR_TRIM_SMITHING_TEMPLATE), "Tide Armor Trim Smithing Template"));
		self::register("vex_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::VEX_ARMOR_TRIM_SMITHING_TEMPLATE), "Vex Armor Trim Smithing Template"));
		self::register("ward_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::WARD_ARMOR_TRIM_SMITHING_TEMPLATE), "Ward Armor Trim Smithing Template"));
		self::register("wayfinder_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE), "Wayfinder Armor Trim Smithing Template"));
		self::register("wild_armor_trim_smithing_template", new SmithingTemplate(new IID(Ids::WILD_ARMOR_TRIM_SMITHING_TEMPLATE), "Wild Armor Trim Smithing Template"));
	}
