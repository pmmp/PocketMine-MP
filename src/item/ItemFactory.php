...
class ItemFactory{
	...
	private function registerTierToolItems() : void{
		...
		$this->register(new Hoe(new ItemIdentifier(ItemIds::NETHERITE_HOE), "Netherite Hoe", ToolTier::NETHERITE()));
		...
		$this->register(new Shovel(new ItemIdentifier(ItemIds::NETHERITE_SHOVEL), "Netherite Shovel", ToolTier::NETHERITE()));
	...
	private function registerArmorItems() : void{
		...
		$this->register(new Armor(new ItemIdentifier(ItemIds::NETHERITE_LEGGINGS, 0), "Netherite Leggings", new ArmorTypeInfo(3, 407, ArmorInventory::SLOT_LEGS)));
