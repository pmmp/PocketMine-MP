...
class ItemFactory{
	...
	public function __construct(){
		...
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_13, 0), "Record 13"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_CAT, 0), "Record Cat"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_BLOCKS, 0), "Record Blocks"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_CHIRP, 0), "Record Chirp"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_FAR, 0), "Record Far"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_MALL, 0), "Record Mall"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_MELLOHI, 0), "Record Mellohi"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_STAL, 0), "Record Stal"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_STRAD, 0), "Record Strad"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_WARD, 0), "Record Ward"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_11, 0), "Record 11"));
		$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_WAIT, 0), "Record Wait"));
		//$this->register(new Record(new ItemIdentifier(ItemIds::RECORD_PIGSTEP, 0), "Record Pigstep"));
