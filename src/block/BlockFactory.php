...
class BlockFactory
{
    ...
    private
    function registerMushroomBlocks(): void
    {
    ...
    private
    function registerSlabWithDoubleHighBitsRemapping(Slab $block): void
    {
        $this->register($block);
     ...
     */
    public
    function register(Block $block, bool $override = false): void
    {
    ...
    public
    function remap(int $id, int $meta, Block $block): void
    {
    ...
    private
    function fillStaticArrays(int $index, Block $block): void
    {
     ...
     */
    public
    function get(int $id, int $meta): Block
    {
    ...
    public
    function fromFullBlock(int $fullState): Block
    {
     ...
     */
    public
    function isRegistered(int $id, int $meta = 0): bool
    {
     ...
     */
    public
    function getAllKnownStates(): array
    {
        return array_filter($this->fullList->toArray(), function (?Block $v): bool {
            return $v !== null;
        });
    }
     ...
     */
    public
    function getMappedStateId(int $fullState): int
    {
