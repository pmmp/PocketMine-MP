...
class Dispenser extends Transparent{
	...
	public function readStateFromData(int $id, int $stateMeta) : void{
		...
		$this->powered = ($stateMeta & BlockLegacyMetadata::DISPENSER_TRIGGERED) !== 0;
	}

	protected function writeStateToMeta() : int{
		return BlockDataSerializer::writeFacing($this->facing) | ($this->powered ? BlockLegacyMetadata::DISPENSER_TRIGGERED : 0);
	}
