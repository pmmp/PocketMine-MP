...
final class KnownTranslationFactory{
	...
	public static function commands_tempban_success(Translatable|string $param0) : Translatable{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TEMPBAN_PLAYER_SUCCESS, [
			0 => $param0,
		]);
	}

	public static function commands_tempban_usage() : Translatable{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TEMPBAN_PLAYER_USAGE, []);
	}

	public static function commands_tempbanip_success(Translatable|string $param0) : Translatable{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TEMPBAN_IP_SUCCESS, [
			0 => $param0,
		]);
	}

	public static function commands_tempbanip_success_players(Translatable|string $param0, Translatable|string $param1) : Translatable{
	...
	public static function commands_tempbanip_usage() : Translatable{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TEMPBAN_IP_USAGE, []);
	}

	public static function commands_tempbanip_invalid() : Translatable{
