	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		if($args[0] === "start"){
			...
			if($sender instanceof Player){
				...
				$message = $sender->getLanguage()->translateString("commands.time.query", [$world->getTime()]);
			}else{
				$world = $sender->getServer()->getWorldManager()->getDefaultWorld();
				$message = $sender->getServer()->getLanguage()->translateString("commands.time.query", [$world->getTime()]);
			}
