...
class BlockFactory{
	...
	public static function init() : void{
		...
		self::registerBlock(new NewBlock(390, 0, "Coral Fan Hang1"));
		self::registerBlock(new NewBlock(391, 0, "Coral Fan Hang2"));
		self::registerBlock(new NewBlock(392, 0, "Coral Fan Hang3"));
		...
		slef::registerBlock(new CommandBlock());
