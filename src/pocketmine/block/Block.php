...
class Block extends Position implements BlockIds, Metadatable{
	...
	public static function init(){
		if(self::$list === null){
			...
			self::$list[self::PORTAL_BLOCK] = PortalBlock::class;
			self::$list[self::LIT_PUMPKIN] = LitPumpkin::class;
			self::$list[self::CAKE_BLOCK] = Cake::class;
			self::$list[self::REPEATER_BLOCK] = RepeaterBlock::class;
			self::$list[self::POWERED_REPEATER_BLOCK] = PoweredRepeaterBlock::class;
			...
			self::$list[self::CAULDRON_BLOCK] = CauldronBlock::class;
			...
			self::$list[self::DAYLIGHT_SENSOR_INVERTED] = DaylightSensorInverted::class;
			...
			self::$list[self::SPRUCE_DOOR_BLOCK] = SpruceDoorBlock::class;
			self::$list[self::BIRCH_DOOR_BLOCK] = BirchDoorBlock::class;
			self::$list[self::JUNGLE_DOOR_BLOCK] = JungleDoorBlock::class;
			self::$list[self::ACACIA_DOOR_BLOCK] = AcaciaDoorBlock::class;
			self::$list[self::DARK_OAK_DOOR_BLOCK] = DarkOakDoorBlock::class;
			self::$list[self::GRASS_PATH] = GrassPath::class;
			self::$list[self::ITEM_FRAME_BLOCK] = ItemFrameBlock::class;
