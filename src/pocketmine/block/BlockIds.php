...
interface BlockIds{
	...
	const SIGN_POST = 63;
	const DOOR_BLOCK = 64, WOODEN_DOOR_BLOCK = 64, WOOD_DOOR_BLOCK = 64, OAK_DOOR_BLOCK = 64;
	const LADDER = 65;
	const RAIL = 66;
	...
	const PORTAL_BLOCK = 90, PORTAL = 90, NETHER_PORTAL = 90;
	const JACK_O_LANTERN = 91, LIT_PUMPKIN = 91;
	const CAKE_BLOCK = 92;
	const REPEATER_BLOCK = 93, UNPOWERED_REPEATER_BLOCK = 93;
	const POWERED_REPEATER_BLOCK = 94, POWERED_REPEATER = 94;
	...
	const COCOA_BLOCK = 127, COCOA_PODS = 127, COCOA_BEANS = 127, COCOA_POD = 127;
	...
	const HEAD_BLOCK = 144, MOB_HEAD_BLOCK = 144, SKULL_BLOCK = 144;
	const ANVIL_BLOCK = 145, ANVIL = 145;
	...
	const COMPARATOR_BLOCK = 149, UNPOWERED_COMPARATOR_BLOCK = 149, UNPOWERED_COMPARATOR = 149;

	const POWERED_COMPARATOR_BLOCK = 150, POWERED_COMPARATOR = 150;
	const DAYLIGHT_SENSOR = 151, DAYLIGHT_DETECTOR = 151;
	...
	const SLIME_BLOCK = 165, const SLIMEBLOCK = 165;
	...
	const INVERTED_DAYLIGHT_SENSOR = 178, DAYLIGHT_SENSOR_INVERTED = 178, DAYLIGHT_DETECTOR_INVERTED = 178;
	const RED_SANDSTONE = 179;
	const RED_SANDSTONE_STAIRS = 180;
	const DOUBLE_RED_SANDSTONE_SLAB = 181, DOUBLE_STONE_SLAB2 = 181;
	...
	const OBSERVER = 251;
	const INFO_RESERVED6 = 255, RESERVED = 255;
}
