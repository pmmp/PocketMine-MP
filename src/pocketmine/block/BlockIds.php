 ...
 *
 * There are some extra constants here that do not appear in Minecraft; these are added by the generator and
 * are here for the sake of clarity and ease of use, and for not following Mojang's inconsistency.
 *
*/
...
interface BlockIds{
	...
	const YELLOW_FLOWER = 37, DANDELION = 37;
	const RED_FLOWER = 38, POPPY = 38;
	...
	const FARMLAND = 60;
	const FURNACE = 61;
	const LIT_FURNACE = 62, BURNING_FURNACE = 62;
	const STANDING_SIGN = 63;
	const WOODEN_DOOR_BLOCK = 64;
	const LADDER = 65;
	const RAIL = 66;
	const STONE_STAIRS = 67, COBBLESTONE_STAIRS = 67;
	const WALL_SIGN = 68;
	const LEVER = 69;
	...
	const LIT_REDSTONE_ORE = 74, GLOWING_REDSTONE_ORE = 74;
	...
	const SOUL_SAND = 88;
	const GLOWSTONE = 89;
	const PORTAL = 90, PORTAL_BLOCK = 90;
	const LIT_PUMPKIN = 91, JACK_O_LANTERN = 91;
	const CAKE_BLOCK = 92;
	...
	const STONEBRICK = 98, STONE_BRICK = 98;
	...
	const OAK_FENCE_GATE = 107, FENCE_GATE = 107;
	const BRICK_STAIRS = 108;
	const STONE_BRICK_STAIRS = 109;
	const MYCELIUM = 110;
	const WATERLILY = 111, WATER_LILY = 111, LILY_PAD = 111;
	...
	const QUARTZ_ORE = 153, NETHER_QUARTZ_ORE = 153;
	...
	const HAY_BLOCK = 170, HAY_BALE = 170;
	const CARPET = 171;
	...
	const MOVING_BLOCK = 250, MOVINGBLOCK = 250;
	const OBSERVER = 251;
