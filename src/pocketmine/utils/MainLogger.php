...
class MainLogger extends \AttachableThreadedLogger{
	...
	protected function send($message, $level, $prefix, $color){
		...
		$message = TextFormat::toANSI(TextFormat::BOLD . TextFormat::RED . "[TesseractPM] " . TextFormat::RESET . TextFormat::AQUA . "[" . date("H:i:s", $now) . "] " . TextFormat::RESET . $color . "[" . $threadName . "/" . $prefix . "]:" . " " . $message . TextFormat::RESET);
