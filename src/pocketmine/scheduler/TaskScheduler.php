...
class TaskScheduler{
	 ...
	 * @return TaskHandler
	 */
	public function scheduleDelayedTask($task, int $delay){
	 ...
	 * @return TaskHandler
	 */
	public function scheduleRepeatingTask($task, int $period){
	 ...
	 * @return TaskHandler
	 */
	public function scheduleDelayedRepeatingTask($task, int $delay, int $period){
