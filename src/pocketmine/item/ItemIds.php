...
interface ItemIds extends \pocketmine\block\BlockIds{
	...
	const WHEAT_SEEDS = 295, SEEDS = 295;
	const WHEAT = 296;
	const BREAD = 297;
	const LEATHER_HELMET = 298, LEATHER_CAP = 298;
	...
	const PAPER = 339;
	const BOOK = 340;
	const SLIME_BALL = 341, SLIMEBALL = 341;
	...
	const CAULDRON = 380;
	const ENDER_EYE = 381;
	const SPECKLED_MELON = 382, GLISTERING_MELON = 382;
	const SPAWN_EGG = 383;
	...
	const HORSEARMORLEATHER = 416;
	const HORSEARMORIRON = 417;
	const HORSEARMORGOLD = 418;
	const HORSEARMORDIAMOND = 419;
	const LEAD = 420;
	...
	const APPLEENCHANTED = 466, APPLE_ENCHANTED = 466;
