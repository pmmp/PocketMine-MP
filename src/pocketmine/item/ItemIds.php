...
interface ItemIds extends BlockIds{
	...
	const SPAWN_EGG = 383;
	const BOTTLE_O_ENCHANTING = 384, ENCHANTING_BOTTLE = 384, EXP_BOTTLE = 384;
	...
	const MINECART_WITH_HOPPER = 408, HOPPER_MINECART = 408;
	...
	const GOLD_HORSE_ARMOR = 418, GOLDEN_HORSE_ARMOR = 418;
