...
abstract class DefaultPermissions{
	...
	public static function registerCorePermissions(){
		...
		self::registerPermission(new Permission(self::ROOT . ".command.clear.self", "Allows the user to clear inventory", Permission::DEFAULT_TRUE), $clear);
		self::registerPermission(new Permission(self::ROOT . ".command.clear.other", "Allows the user to clear other players inventory"), $clear);
