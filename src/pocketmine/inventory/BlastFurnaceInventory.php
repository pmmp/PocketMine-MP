 ...
 */
 ...
 use pocketmine\tile\BlastFurnace;

 class BlastFurnaceInventory extends ContainerInventory{
 	/** @var BlastFurnace */
 	protected $holder;

 	public function __construct(BlastFurnace $tile){
 		parent::__construct($tile);
 	}

 	public function getNetworkType() : int{
 		return WindowTypes::BLAST_FURNACE;
 	}
