...
class BossEventPacket extends DataPacket{
	...
	/* S2C: Currently bar percentage only appears to change in response to the target entity's health. */
	public const TYPE_HEALTH_PERCENT = 4;
	/* S2C: Title client-side sticks as the target entity's nametag, or their entity type name if not set. */
