...
abstract class Mob extends Living{
	...
	protected function initEntity() : void{
		...
		if($this->namedtag->hasTag("NoAI", ByteTag::class)){
			$this->setImmobile(boolval($this->namedtag->getByte("NoAI")));
		}else{
			$this->setImmobile(boolval($this->namedtag->getByte("Immobile", 1)));
		}
	}
