...
final class BlockStateDeserializerHelper{
	...
	/**
	 * @phpstan-template TBlock of Copper|CopperSlab|CopperStairs|CopperBulb
	 *
	 * @phpstan-param TBlock $block
	 * @phpstan-return TBlock
	 */
	public static function decodeCopper(Copper|CopperSlab|CopperStairs|CopperBulb $block, CopperOxidation $oxidation) : Copper|CopperSlab|CopperStairs|CopperBulb{
	 ...
	 * @phpstan-return TBlock
	 */
	public static function decodeWaxedCopper(Copper|CopperSlab|CopperStairs|CopperBulb $block, CopperOxidation $oxidation) : Copper|CopperSlab|CopperStairs|CopperBulb{
		$block->setOxidation($oxidation);
		$block->setWaxed(true);
		return $block;
	}
