 ...
 */
final class CardinalHorizontalFacingProperty implements Property{
	use SingletonTrait;
	...
	public function deserialize(Block $block, BlockStateReader $in) : void{
		$value = $in->readCardinalHorizontalFacing();
		$block->setFacing($value);
	}

	public function serialize(Block $block, BlockStateWriter $out) : void{
		$value = $block->getFacing();
		$out->writeCardinalHorizontalFacing($value);
	}
}
