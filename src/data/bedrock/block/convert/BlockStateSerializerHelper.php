...
final class BlockStateSerializerHelper{
	...
	public static function encodeCeilingHangingSign(CeilingHangingSign $block, BlockStateWriter $out) : Writer{
		return $out
	...
	public static function encodeWallHangingSign(WallHangingSign $block, BlockStateWriter $out) : Writer{
		return $out
