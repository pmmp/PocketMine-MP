...
class AreaEffectCloudApplyEvent extends EntityEvent implements Cancellable{
	 ...
	 *
	 * It is important to note that not every entity is guaranteed to be effected.
	 * The cloud may die during the application of its effects due to the depletion
	 * of {@link AreaEffectCloud::getDurationChangeOnUse()} or {@link AreaEffectCloud::getRadiusChangeOnUse()}.
	 *
	 * @return Living[]
	 */
