...
final class VillagerV2 extends Living implements Ageable{
	...
	public function onInteract(Player $player, Vector3 $clickPos) : bool{
		...
		// If the profession has no recipes (not implemented yet), provide a simple placeholder
		// so the client UI shows at least one trade instead of being empty.
		if(count($this->recipeData->getRecipes()) === 0){
			// Example placeholder: 1 emerald -> 1 bread
			$this->recipeData->addRecipe(new TradeRecipe(VanillaItems::EMERALD()->setCount(1), VanillaItems::BREAD()->setCount(1)));
		}
