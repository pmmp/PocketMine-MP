...
abstract class Entity{
	...
	protected function syncNetworkData(EntityMetadataCollection $properties) : void{
		...
		$properties->setFloat(EntityMetadataProperties::BOUNDING_BOX_HEIGHT, $this->scale > 0 ? $this->size->getHeight() / $this->scale: 0);
		$properties->setFloat(EntityMetadataProperties::BOUNDING_BOX_WIDTH, $this->scale > 0 ? $this->size->getWidth() / $this->scale: 0);
